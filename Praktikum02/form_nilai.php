    ...
    <div class="container">
        ...
        <div class="form-group row">
            ...
            <select id="matkul" name="matkul" class="custom-select" required="required">
                <option value="Pemograman Website">Pemograman Web</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
            <input id="tugas" name="tugas" placeholder="Masukkan Nliai Tugas" type="text" class="form-control" required="required">
            </div>
        </div>
        <div class="form-group row">
